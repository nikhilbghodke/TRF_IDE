        ...
        for (a = a.getInputTargetBlock("STACK"); a;) {
            switch (a.type) {
                case "controls_if_elseif":
                    this.elseifCount_++;
                    var b = this.appendValueInput("IF" + this.elseifCount_).setCheck(["Boolean", "Number"]).appendField(Blockly.Msg.CONTROLS_IF_MSG_ELSEIF),
        ...
        for (a = a.getInputTargetBlock("STACK"); a;) {
            switch (a.type) {
                case "controls_switch_case":
                    this.caseCount_++;
                    var b = this.appendValueInput("CASE" + this.caseCount_).setCheck("Number",
                            "INT", "Variable", "VAR_INT").appendField(Blockly.Msg.CONTROLS_SWITCH_CASE),
                        c = this.appendStatementInput("DO" + this.caseCount_);
                    c.appendField(Blockly.Msg.CONTROLS_IF_MSG_THEN);
                    a.valueConnection_ && b.connection.connect(a.valueConnection_);
                    a.statementConnection_ && c.connection.connect(a.statementConnection_);
                    break;
    ...
    onchange: function() {
        ...
        if (this.workspace) {
            for (var a = this, b = !1; a.getSurroundParent();)
                ...
                a.updateShape();
                var b = a.getFieldValue("DISTS"),
                    c = a.getFieldValue("TYPES");
                "array" == b && (b = "variable");
...
Blockly.Blocks.procedures_defnoreturn = {
    ...
    decompose: function(a) {
        ...
        for (var c = b.getInput("STACK").connection, e = 0; e < this.arguments_.length; e++) {
            var d;
            "v" == this.dist_[e] ? (d = Blockly.Block.obtain(a, "procedures_mutatorarg"), d.initSvg(), d.setFieldValue(this.arguments_[e], "NAME"),
                d.setFieldValue(this.types_[e], "TYPES")) : "a" == this.dist_[e] ? (d = Blockly.Block.obtain(a, "procedures_mutatorarg_array"), d.initSvg(), d.setFieldValue(this.arguments_[e], "NAME"), d.setFieldValue(this.types_[e], "TYPES"), 1 == this.spec_[e][0] ? d.setFieldValue(this.spec_[e][1], "LENGTH_1") : 2 == this.spec_[e][0] ? (d.setFieldValue(this.spec_[e][1], "LENGTH_1"), d.setFieldValue(this.spec_[e][2], "LENGTH_2")) : 3 == this.spec_[e][0] && (d.setFieldValue(this.spec_[e][1], "LENGTH_1"), d.setFieldValue(this.spec_[e][2], "LENGTH_2"),
                d.setFieldValue(this.spec_[e][3], "LENGTH_3"))) : "p" == this.dist_[e] && (d = Blockly.Block.obtain(a, "procedures_mutatorarg_pointer"), d.initSvg(), d.setFieldValue(this.arguments_[e], "NAME"), d.setFieldValue(this.types_[e], "TYPES"), d.setFieldValue(this.spec_[e], "ITERATION"));
            d.oldLocation = e;
            c.connect(d.previousConnection);
            c = d.nextConnection
        }
    ...
    compose: function(a) {
        ...
        for (var b = a.getInputTargetBlock("STACK"); b;) {
            ...
            if ("v" == b.getDist()) this.spec_.push(null);
                ...
                var c = b.getFieldValue("LENGTH_1"),
                    ...
                    f = 1 * e,
                    h = 1 * d;
                0 != g && 0 == f && 0 == h ? this.spec_.push([1, c]) : 0 != g && 0 != f && 0 == h ? this.spec_.push([2,
                    c, e
                ]) : 0 != g && 0 != f && 0 != h && this.spec_.push([3, c, e, d])
        ...
        if (null !== a && (a = "TRUE" == a, b = this.getInput("STACK"), b.isVisible() != a)) {
            if (a) b.connection.targetConnection ||
    ...
    renameVar: function(a, b) {
        ...
        if (c && (this.updateParams_(), this.mutator.isVisible_()))
            for (var c = this.mutator.workspace_.getAllBlocks(), e = 0, d; d = c[e]; e++) "procedures_mutatorarg" == d.type && Blockly.Names.equals(a,
...
Blockly.Blocks.structure_define = {
    ...
    decompose: function(a) {
        ...
        for (var c = b.getInput("STACK").connection, e = 0; e < this.members_.length; e++) {
            var d;
            "v" == this.dist_[e] ? (d = Blockly.Block.obtain(a, "structure_mutatormem"), d.initSvg(), d.setFieldValue(this.members_[e], "NAME"), d.setFieldValue(this.types_[e], "TYPES")) : "a" == this.dist_[e] ? (d = Blockly.Block.obtain(a, "structure_mutatormem_array"), d.initSvg(), d.setFieldValue(this.members_[e], "NAME"), d.setFieldValue(this.types_[e], "TYPES"), d.setFieldValue(this.spec_[e], "LENGTH")) : "p" == this.dist_[e] && (d = Blockly.Block.obtain(a, "structure_mutatormem_pointer"),
                d.initSvg(), d.setFieldValue(this.members_[e], "NAME"), d.setFieldValue(this.types_[e], "TYPES"), d.setFieldValue(this.spec_[e], "ITERATION"));
            d.oldLocation = e;
            c.connect(d.previousConnection);
            c = d.nextConnection
        }
    ...
    compose: function(a) {
        ...
        this.dist_ = [];
        this.spec_ = [];
        for (var b = a.getInputTargetBlock("STACK"); b;) this.members_.push(b.getFieldValue("NAME")),
            this.types_.push(b.getFieldValue("TYPES")), this.dist_.push(b.getDist()), "v" == b.getDist() ? this.spec_.push(b.getFieldValue()) : "a" == b.getDist() ? this.spec_.push(b.getFieldValue("LENGTH")) : "p" == b.getDist() && this.spec_.push(b.getFieldValue("ITERATION")), this.paramIds_.push(b.id), b = b.nextConnection && b.nextConnection.targetBlock();
        this.updateParams_();
        Blockly.Procedures.mutateCallers(this.getFieldValue("NAME"), this.getFieldValue("TYPES"), this.workspace, this.members_, this.types_, this.dist_, this.spec_, this.paramIds_);
        a = a.getFieldValue("STATEMENTS");
        if (null !== a && (a = "TRUE" == a, b = this.getInput("STACK"), b.isVisible() != a)) {
    ...
    renameVar: function(a, b) {
        ...
        if (c && (this.updateParams_(), this.mutator.isVisible_()))
            for (var c = this.mutator.workspace_.getAllBlocks(),
                    e = 0, d; d = c[e]; e++) "structure_mutatormem" == d.type && Blockly.Names.equals(a, d.getFieldValue("NAME")) && d.setFieldValue(b, "NAME")
    },
    getDist: function() {
        return ["sd"]
    },
...
Blockly.Blocks['wait_milisecond'] = {
  init: function() {
    this.appendValueInput("time")
        .setCheck("Number")
        .appendField("wait");
    this.appendDummyInput()
        .appendField("milisecond");
...
Blockly.Blocks['io_digitalread'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("read digital pins #")
        .appendField(new Blockly.FieldDropdown(arduinoDigitalPins), "NAME");
    this.setInputsInline(true);
 ...
 this.setHelpUrl("");
  ...
  onchange: function(event) {
    this.previousValue=this.getFieldValue("NAME");
   // console.log(event);
...
Blockly.Blocks['io_digitalwrite'] = {
  init: function() {
    ...
    this.appendValueInput("state")
        .setCheck("Boolean")
        .appendField("set digital pins #")
        .appendField(new Blockly.FieldDropdown(arduinoDigitalPins), "pins");
 ...
 this.setHelpUrl("");
    ...
    onchange: function(event) {
    this.previousValue=this.getFieldValue("pins");
    }
};
